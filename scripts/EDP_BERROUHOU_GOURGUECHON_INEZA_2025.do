...
save "data/processed/EDP_Berrouhou_Gourguechon_Ineza_2025.dta", replace
...
graph export "output/figures/Graph4_Time_Effects.png", replace
...
preserve
    ...
    twoway (line LPtb year if educ_group==4, lcolor(forest_green) lwidth(thick)) ///
           ...
           scheme(s1mono) name(g5, replace)

    graph export "output/figures/Graph5_Education_Gap.png", replace
restore
